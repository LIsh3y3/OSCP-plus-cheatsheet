...
- [4. XSS contexts](4.%20XSS%20contexts.md#HTMLタグ内でのXSS)
- [4. XSS contexts](4.%20XSS%20contexts.md#HTMLタグの属性内のXSS)
- [4. XSS contexts](4.%20XSS%20contexts.md#JavaScriptへのXSS)
	- [4. XSS contexts](4.%20XSS%20contexts.md#既存のスクリプトを強制終了させ任意のJSを実行する方法)
	- [4. XSS contexts](4.%20XSS%20contexts.md#引用符('or")で囲まれた文字列からの脱却)
	- [4. XSS contexts](4.%20XSS%20contexts.md#HTMLエンコードの利用)
	- [4. XSS contexts](4.%20XSS%20contexts.md#JSテンプレートリテラルの利用)
- [4. XSS contexts](4.%20XSS%20contexts.md#Misc)
	- [4. XSS contexts](4.%20XSS%20contexts.md#難読化)
	- [4. XSS contexts](4.%20XSS%20contexts.md#クエリストリングへの埋め込み)
	- [4. XSS contexts](4.%20XSS%20contexts.md#もしURLエンコードされて実行されないならWebキャッシュポイズニング)
...
4. コンテキストに合わせ改変したペイロードをエクスプロイトサーバにホストしてView Exploitで検証する[4. XSS contexts](4.%20XSS%20contexts.md#🚨：HTMLタグ内でのXSSペイロード注入時の注意点)
```html
...
&apos;-alert(1)-&apos;
```
- [4. XSS contexts](4.%20XSS%20contexts.md#基本的な文字列からの脱却)の引用符をHTMLエンコードする
