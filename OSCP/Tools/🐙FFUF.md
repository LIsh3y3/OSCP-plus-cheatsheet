...
SOCKSプロキシ実行
```zsh
ffuf -o ffuf.json -recursion -recursion-depth 2 -x socks5://localhost:<Port> -e .php,.jsp,.txt,.cgi,.asp,.aspx -u http://<TargetIP>/FUZZ -w /usr/share/seclists/Discovery/Web-Content/common.txt
